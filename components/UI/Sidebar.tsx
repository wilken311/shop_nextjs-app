        ...
        >
          ...
          <ul className="md:flex-col md:min-w-full flex flex-col list-none">
            <li className="items-center my-2">
              <i className="fas fa-tv opacity-75 mr-2 text-sm block "></i>
              <Link href="/dashboard">
                <a className="text-pink-500 hover:text-pink-600  text-xs uppercase py-3 font-bold">
                  Dashboard
                </a>
              </Link>
            </li>
            ...
            <li className="items-center my-2">
              <i className="fas fa-shop text-blueGray-400 mr-2 text-sm block"></i>
              <Link href="/products">
                <a className="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold">
                  Products
                </a>
              </Link>
            </li>
            ...
            {/* <li className="items-center my-2">
              <i className="fas fa-user-circle text-blueGray-400 mr-2 text-sm block"></i>
              <Link href="/">
                <a className="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold">
                  Profile Page
                </a>
            ...
            <li className="items-center my-2">
              <i className="fas fa-fingerprint text-blueGray-400 mr-2 text-sm block"></i>
              <Link href="/">
                <a className="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold">
                  Login
                </a>
          ...
          <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
            <li className="inline-flex">
              <i className="fas fa-user mr-2 text-blueGray-400 text-base"></i>
              <Link href="/">
